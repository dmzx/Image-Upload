...
$lang = array_merge($lang, array(
	...
	'ACP_IMAGEUPLOAD_INDEX_ENABLE'			=> 'Habilitar imágenes en el índice',
	'ACP_IMAGEUPLOAD_INDEX_ENABLE_EXPLAIN'	=> 'Global On/Off de las imágenes en el índice para todos los miembros.<br />Los miembros pueden establecer en el PCU si quieren ver las imágenes subidas en el índice.',
	...
	'ACP_IMAGEUPLOAD_SORT_USERNAME'			=> 'Nombre de usuario',
	'ACP_IMAGEUPLOAD_SORT_DATE'				=> 'Fecha',
	'ACP_IMAGEUPLOAD_NOT_SELECTED'			=> 'No ha seleccionado ninguna imagen',
	'ACP_IMAGEUPLOAD_CHAT_ENABLE'			=> 'Habilitar publicación de imágenes en mChat',
	'ACP_IMAGEUPLOAD_CHAT_ENABLE_EXPLAIN'	=> 'Establecer en Si para insertar imágenes subidas en el índice con un clic.',
));
